...
def attack(char_name: str, char_class: str) -> str:
    '''Наносит урон противнику в зависимости от класса игрока'''
...
def defence(char_name: str, char_class: str) -> str:
    '''
    Возвращает сколько урона заблокировал игрок
...
def special(char_name: str, char_class: str) -> str:
    '''Возвращает особую ататаку, в зависимости от класса игрока'''
    if char_class == 'warrior':
